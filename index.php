...
if (isset($_POST['btn-signup'])) {
	...
	if ($uname == "") {
		...
		echo '<script>alert("This type of file is not supported!");</script>';
	} else if ($pic == "") {
		$error[] = "Select Image!";
	} else if ($umail == "") {
		...
		if ($sql) {
			...
			$error[] = "Registration successful. To login click on the Sign In button";
			echo '<script>alert("Registration successful. To login click on the Sign In button");</script>';
			$icon = "success";
			$class = "success";
		}
	}
