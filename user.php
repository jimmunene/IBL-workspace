	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">ArtBeat Kenya </label>
				<label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Hello! <font style="font-size:medium"> <?php echo $_SESSION["name"]; ?></font> </label>
...
-->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title" id="lineModalLabel">What's your Art about?</h3>
				</div>
				<div class="modal-body">
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Art Work Title</label>
							<textarea name="status_title" class="form-control" placeholder="eg:The River of Souls"></textarea>

						</div>

						<div class="form-group">
							<label for="exampleInputPassword1">Describe your Art Work in more detail</label>
							<div class="row">
						...
						<div class="modal-footer">
							<div class="btn-group btn-group-justified" role="group" aria-label="group button">
								...
								<div class="btn-group" role="group">
									<button type="submit" name="submit" class="btn btn-default btn-hover-green" value="Post">Post Art</button>
								</div>
							</div>
						</div>
		...
		<div class="container-fluid">
			...
			<div id="sidebar-wrapper">
				<ul class="sidebar-nav">
					...
					<li>
						<a href="home.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>
 ...
 -->
					<li>
						<a href="mytask.php"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> My Art Work</a>
					</li>
			...
			<div class="col-lg-10">
				<div class="col-lg-2">
					<div class="list-group" style="margin-left:0px">
						...
						<a href="ourskill.php" class="list-group-item">My Profile
						</a>


						</a>
						<a href="my_task.php" class="list-group-item">My Art Work
						</a>
						<a href="" data-toggle="modal" data-target="#squarespaceModal" class="list-group-item">
							Post Art
						</a>
						<a href="notification.php" class="list-group-item">
							Notifications(<?php echo $count; ?>)
						</a>
